...
- **(c)** *Preventing motor vehicles from rolling away*
  ...
  - **(3)** *Deadline* The rule under paragraph (1) shall become effective on September 1 of the year that is 1 year after the date on which the Secretary issues that rule.
