...
## § 2. Extension of authority to make grants to Veterans Service Organizations for transportation of highly rural veterans
...
## § 5. Comptroller General of the United States report on transportation services for veterans
...
- **(b)** *Contents* The report submitted under subsection (a) shall include the following:
  ...
  - **(8)** An assessment of other options for transportation under the program, such as local taxi companies and ridesharing programs such as Uber and Lyft.
