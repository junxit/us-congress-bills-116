...
>   - **(1)** with respect to an event described in sections 1 through 6 of Form 8–K, between—
>     - **(A)** the occurrence of such event; and
>     - **(B)** the filing or furnishing of a current report on Form 8–K with respect to such event; and
>   - **(2)** with respect to an event described in section 7 or 8 of Form 8–K, between—
>     - **(A)** the date on which the issuer determines that it will disclose such event; and
>     - **(B)** the filing or furnishing of a current report on Form 8–K with respect to such event.
...
>     - **(B)** was adopted—
>       - **(i)** with respect to an event described in sections 1 through 6 of Form 8–K, between—
>         - **(I)** the occurrence of such event; and
