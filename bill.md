...
This Act may be cited as the “Bridge Investment Act of 2020”.
...
- **(a)** *In general* Chapter 1 of title 23, United States Code, is amended by inserting after section 123 the following:
  ...
  >       - **(iii)** the average amount of people and freight supported by the eligible project;
  ...
  >       - **(vii)** geographic diversity among grant recipients, including the need for a balance between the needs of rural and urban communities;
  >       - **(viii)** the extent to which an eligible project improves intermodal freight transport;
  >       - **(ix)** the number of eligible projects within the same State;
  >       - **(x)** whether the project serves as part of a State or Federal evacuation route; and
  >       - **(xi)** the extent to which a bridge that would be assisted with a grant—
  ...
  >         - **(VIII)** environmental benefits, including wildlife connectivity and carbon reduction;
  >         - **(IX)** benefits to pedestrian, bicycle, nonvehicular, and public transportation users;
  >         - **(X)** benefits of using—
  ...
  >   - **(2)** *GAO assessment and report* Not later than 3 years after the date of enactment of the Bridge Investment Act of 2020, the Comptroller General of the United States shall—
  ...
  > - **(o)** *Tribal transportation facility bridge set aside*
  ...
  > - **(p)** *Authorization of appropriations* For each of fiscal years 2021 through 2025, there is authorized to be appropriated to carry out this section—
  >   - **(1)** $2,000,000,000 from the general fund of the Treasury; and
  >   - **(2)** $2,000,000,000 from the Highway Trust Fund (other than the Mass Transit Account).
