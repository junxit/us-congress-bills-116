...
- **(1)** by amending paragraph (16) to read as follows:
  ...
  >   - **(C)** *Rule of construction* Nothing in this paragraph shall be construed to allow a Federal agency to establish a goaling requirement for lower-tier subcontractors of a prime contractor that is eligible to receive lower-tier subcontracting credit under this paragraph

- **(2)** by adding at the end the following:
  > - **(18)** *Dispute process for non-payment to subcontractors*
  >   - **(A)** *Notice to agency* With respect to a contract with a Federal agency, a subcontractor of a prime contractor on such contract may, if the subcontractor has not received payment for performance on such contract within 30 days of the completion of such performance, notify the Office of Small and Disadvantaged Business Utilization (“OSDBU”) of the Federal agency and the prime contractor of such lack of payment, if such notice is provided to the agency within the 15-day period following the end of such 30 days.
