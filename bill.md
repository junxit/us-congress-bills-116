...
> To require GAO review of certain TSA screening protocols, and for other purposes.
...
- **(3)** Assess whether TSA effectively tracks passenger complaints related to such screening to monitor trends and identify inconsistencies.
- **(4)** Evaluate TSA’s communications and information sharing practices for passengers, air carriers, and airports relating to screening protocols for such screening.
- **(5)** Evaluate TSA’s policies regarding the screening of passengers with nursing products, including the extent to which such passengers are more likely to receive secondary screening.
- **(6)** Make recommendations for improving TSA’s overall screening practices relating to such screening.
