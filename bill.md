...
## § 3. Renewable electricity standard
...
- **(a)** *In general* Title VI of the Public Utility Regulatory Policies Act of 1978 (16 U.S.C. 2601 et seq.) is amended by adding at the end the following:
  ...
  >   - **(2)** *Eligible facility* The term eligible facility means a facility for the generation of electric energy that—
  ...
  >     - **(D)** generates electric energy from a renewable energy resource using equipment that comes online after calendar year 2005 and before calendar year 2020, and that electric energy—
  >       - **(i)** is not under a contract for the sale of renewable energy credits or physical power to—
  ...
  >       - **(ii)**
  >         - **(I)** is delivered for end-use consumption in the regional reliability entity (as recognized by the North American Electric Reliability Corporation) in which the retail electric supplier is located; and
  >         - **(II)** the end-use consumption within that region can be tracked and verified.
  >   - **(3)** *Impacted community* The term impacted community means—
  ...
  >   - **(7)** *Renewable Biomass*
  >     - **(A)** *In general* The term renewable biomass means—
  >       - **(i)** crop byproducts or crop residues that—
  ...
  >       - **(vi)** algae;
  >       - **(vii)** nonhazardous plant matter derived from waste—
  ...
  >   - **(9)** *Renewable energy resource* The term renewable energy resource means—
  >     - **(A)** solar;
  >     - **(B)** wind;
  >     - **(C)** ocean;
  >     - **(D)** tidal;
  ...
  >   - **(1)** *In general* Not later than December 31, 2020, a retail electric supplier that has reason to believe the retail electric supplier will not be able to fully comply with subsection (b) may—
  ...
  > - **(h)** *Alternative compliance payments* As a means of compliance under subsection (b)(3), the Secretary shall accept payment equal to the lesser of—
  ...
  > - **(k)** *State programs*
  >   - **(1)** *In general* Nothing in this section preempts or affects any authority of a State, political subdivision of a State, or interstate compact—
  ...
  >     - **(B)** *Eligibility* A State may elect not to participate in this section if the Secretary determines that—
  ...
  >       - **(ii)** *Issuance of Federal renewable energy credits*
  ...
  >   - **(2)** *Evaluation* The study under paragraph (1) shall include an evaluation of—
  ...
  >     - **(E)** the net cost or benefit of the renewable electricity standard to the national and State economies, including—
  ...
  >     - **(B)** *Use* A grant under this paragraph shall be used for the purpose of—
