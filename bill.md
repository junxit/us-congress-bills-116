...
- **(a)** *In general* Section 1886(h) of the Social Security Act (42 U.S.C. 1395ww(h)) is amended—
  ...
  - **(4)** by adding at the end the following new paragraph:
    ...
    >       - **(I)** reduce the otherwise applicable resident limit of the hospital by the amount by which such limit was increased under this subparagraph; and
    >       - **(II)** provide for the distribution of positions attributable to such reduction in accordance with the requirements of this paragraph.
    >   - **(D)** *Distribution of remaining positions* If the aggregate number of positions distributed under subparagraphs (B) and (C) during the period of fiscal years 2022 through 2026 is less than 1000, the Secretary shall distribute the remaining residency positions in succeeding fiscal years according to criteria consistent with this paragraph until such time as the aggregate amount of positions distributed under this paragraph is equal to 1000.
...
- **(b)** *IME*
  ...
  - **(2)** *Conforming provision* Section 1886(d)(5)(B) of the Social Security Act (42 U.S.C. 1395ww(d)(5)(B)) is amended—
    ...
    - **(B)** by adding after clause (xi), as redesignated by subparagraph (A), the following new clause:
      > - **(xii)** For discharges occurring on or after July 1, 2022, insofar as an additional payment amount under this subparagraph is attributable to residency positions distributed to a hospital under subsection (h)(9), the indirect teaching adjustment factor shall be computed in the same manner as provided under clause (ii) with respect to such residency positions.
