...
- **(a)** *In general* Subsection (i) of section 402 of the Surface Mining Control and Reclamation Act of 1977 (30 U.S.C. 1232) is amended—
  ...
  - **(3)** by inserting after paragraph (3) the following:
    ...
    >   - **(E)** *Requirement to maintain contribution rate* No transfer under subparagraph (A) shall be made for a fiscal year unless the persons that are obligated to contribute to the 1974 UMWA Pension Plan as of the date of the transfer are obligated to make such contributions at rates that are no less than those in effect on the date which is 30 days before the date of enactment of the Miners Pension Protection Act.
...
## § 3. Reduction in minimum age for allowable in-service distributions
