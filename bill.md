...
## § 2. Study on blockchain technology and its use in consumer protection
...
- **(a)** *In general*
  ...
  - **(2)** *Requirements for study* In conducting the study, the Secretary shall examine—
    ...
    - **(E)** areas in Federal regulation of blockchain technology where greater clarity would encourage domestic innovation; and
