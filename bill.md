...
> To amend title 38, United States Code, to provide for a reduction in certain loan fees for certain veterans affected by major disasters.

## § 1. Reducing loan fees for certain veterans affected by major disasters
...
- **(1)** by striking subparagraph (D), and inserting the following new subparagraph (D):
  ...
  >     - **(II)** such loan is only for repairs or construction, as determined by the Secretary.
