...
- **(a)** *In general* Subchapter II of chapter 11 of title 38, United States Code, is amended by adding at the end the following new section:
  ...
  >     - **(B)** was awarded any of the following:
  >       - **(i)** The Southwest Asia Service Medal.
  >       - **(ii)** The Global War on Terrorism Expeditionary Medal.
  >       - **(iii)** A campaign medal in recognition of service in any of the following:
  ...
  >         - **(VII)** Operation Odyssey Lightning.
  >         - **(VIII)** Operation Pacific Eagle.
  >   - **(4)** A military operation described in this paragraph is—
  >     - **(A)** any contingency operation (as defined in section 101(a)(13) of title 10); or
  >     - **(B)** any military operation in any of the following countries or territories:
  >       - **(i)** Afghanistan.
  >       - **(ii)** Bahrain
  >       - **(iii)** Burkina Faso.
  >       - **(iv)** Cameroon.
...
- **(d)** *Recommendations for additional scientific studies*
  ...
  - **(2)** *Considerations* In making rec­om­men­da­tions for additional scientific studies, the National Academies shall consider—
