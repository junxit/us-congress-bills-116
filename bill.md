...
- **(1)** in subsection (c)—
  - **(A)** in paragraph (2)—
    ...
    - **(iii)** by adding at the end the following:
      > - **(C)** *Emerging harbor project priority* In addition to the priority given under subparagraph (B), the Secretary shall give equal priority to an application for a project that would increase the availability of broadband service in an emerging harbor project (as defined in section 210(f) of the Water Resources Development Act of 1986 (33 U.S.C. 2238(f))), without regard to whether the application is from an emerging harbor project.
      ...
      >     - **(I)** conferring with and obtaining data from the Federal Communications Commission and the Assistant Secretary of Commerce for Communications and Information with respect to the service area proposed in the application;
