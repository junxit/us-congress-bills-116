...
- **(c)** *Surface owner protection*
  - **(1)** *Post-lease surface use agreement*
    ...
    - **(B)** *Contents* The surface use agreement shall provide for—
      ...
      - **(iv)** compensation for damages as a result of exploration and drilling operations, including—
  ...
  - **(3)** *Surface owner notification* The Secretary shall notify surface estate owners in writing—
