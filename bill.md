...
## § 2. Information sharing related to State guardianship status
...
- **(a)** *In general* Section 205(j)(11) of the Social Security Act (42 U.S.C. 405(j)(11)) is amended—
  - **(1)** by redesignating subparagraph (B) as subparagraph (C) and by inserting after subparagraph (A) the following:
    ...
    >   - **(ii)** in any case in which the guardianship arrangement for such an individual has changed in such month, redetermine the appropriate representative payee for such individual.
