...
- **(e)** *Administration*
  ...
  - **(2)** *Management plan*
    ...
    - **(B)** Upon completion, the Secretary shall submit the general management plan prepared pursuant to subparagraph (A) to the Committee on Natural Resources of the House of Representatives and Committee on Energy and Natural Resources of the Senate.
- **(f)** *Cooperative agreements* The Secretary shall enter into cooperative agreements with the Blackwell School Alliance (and other local, regional, State, academic and non-profit partners) for interpretive and educational programming, technical assistance, and rehabilitation related to the national historic site.
