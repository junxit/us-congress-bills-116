...
## § 2. Improvements to the program of comprehensive assistance for family caregivers
...
- **(c)** *Standardized application procedures* Paragraph (5) of such section is amended to read as follows:
  > - **(5)**
  >   - **(A)** For each application submitted jointly by an eligible veteran and family member, the Secretary shall evaluate (in collaboration with the primary care team for the eligible veteran to the maximum extent practicable)—
