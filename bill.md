...
## § 2. Commodity Futures Trading Commission Customer Protection Fund
...
- **(2)** in paragraph (3)—
  ...
  - **(E)** by adding at the end the following:
    ...
    >   - **(ii)** *Use of separate account* The separate account referred to in clause (i) shall be available to the Commission, without further appropriation or fiscal year limitation, for the purposes described in subparagraphs (B) through (D) of paragraph (2).
