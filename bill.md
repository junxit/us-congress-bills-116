...
- **(a)** *In general* Section 45(e)(10) of the Internal Revenue Code of 1986 is amended—
  - **(1)** in subparagraph (A), by striking “the applicable dollar amount per ton of Indian coal” and all that follows and inserting the following:
    > $4.00 per ton of Indian coal—
    > - **(i)** produced by the taxpayer at an Indian coal production facility, and
    > - **(ii)** sold (either directly by the taxpayer or after sale or transfer to one or more related persons) to an unrelated person during such taxable year.
