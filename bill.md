...
This Act may be cited as the “Employment Services and Jobs Parity Act of 2019”.

## § 2. Inclusion of Commonwealth of the Northern Mariana Islands and American Samoa
...
- **(3)** in section 6(a) (29 U.S.C. 49e(a))—
  ...
  - **(B)** by striking “allot to Guam” and inserting the following:
    > allot to—
    > - **(1)** Guam

  - **(C)** by striking the period at the end and inserting “; and”; and
  - **(D)** by adding at the end the following:
    > - **(2)** the Commonwealth of the Northern Mariana Islands and American Samoa an amount which, in relation to the total amount available for the fiscal year, is equal to the allotment percentage that Guam received of amounts available under this Act in fiscal year 1983.
