...
- **(b)** *Technical and conforming amendments*
  - **(1)** Section 103 of the Truth in Lending Act (15 U.S.C. 1602) is amended by adding at the end the following:
    ...
    >   - **(1)** regardless of whether the obligation is absolute or contingent if the understanding between the parties is that any part of the money shall be or may be returned;
