...
- **(1)** in subsection (c), by adding at the end the following:
  ...
  >   - **(B)** *Use of algorithms* If an algorithm of a social media service is used to engage in an action related to user-generated content that is described in subparagraph (A), such action shall be considered to be the action of the owner or operator of the social media service.
