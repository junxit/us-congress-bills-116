...
- **(1)** in subparagraph (E)—
  ...
  - **(B)** by striking the second sentence and inserting the following:
    ...
    >   - **(IX)** other relevant considerations, as the Secretary may describe in guidance.
