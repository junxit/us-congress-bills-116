...
- **(a)** *Energy management requirements* Section 543(f)(4) of the National Energy Conservation Policy Act (42 U.S.C. 8253(f)(4)) is amended—
  ...
  - **(2)** in the matter preceding subparagraph (A), by striking “may” and all that follows through “the Federal” in subparagraph (A) and inserting the following:
    > shall implement any energy- or water-saving measure that—
    > - **(i)** the Federal
  ...
  - **(4)** in subparagraph (A) (as so designated)—
    - **(A)** in clause (i), by striking “paragraph (3) that is” and inserting the following:
      > paragraph (3); and
      > - **(ii)** is
