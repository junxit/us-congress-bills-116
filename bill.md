...
## § 1. Expanding permitted uses of incentive payments
...
- **(2)** by adding at the end the following new subsection:
  > - **(g)** *Definitions of parenting time arrangement and noncustodial parent*
  >   - **(1)** *Parenting time arrangement* For purposes of subsection (f)(2), the term parenting time arrangement means an arrangement governing how much time a child spends with the child's custodial parent and the child's noncustodial parent that is mutually agreed to by the parents and is not contested by either parent in any forum.
