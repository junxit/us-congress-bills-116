...
>   - **(1)** be nationwide;
>   - **(2)** include diversity of enrollees to account for gender, age, race, ethnicity, geography, co­mor­bid­i­ties, and underrepresented populations, including pregnant and lactating women;
...
>   - **(6)** monitor individuals enrolled in the study not less frequently that twice per year after the first year of the individual's infection with COVID–19.
