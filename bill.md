...
This Act may be cited as the “Quantum Network Infrastructure Act of 2020”.
...
## § 3. Department of Energy Quantum Network Infrastructure Research and Development Program
...
>   - **(2)** improve the precision of measurements of scientific phenomena and physical imaging technologies; and
...
>     - **(H)** integration of systems across the quantum technology stack into traditional computing networks, including the development of remote controlled, high performance, and reliable implementations of key quantum network components;
...
>   - **(4)** advance basic research in advanced scientific computing and material science to enhance the understanding, prediction, and manipulation of materials and processes relevant to quantum network infrastructure;
>   - **(5)** develop experimental tools and testbeds necessary to support cross-cutting fundamental research and development activities with diverse stakeholders from industry and institutions of higher education; and
...
> - **(d)** *Research plan* Not later than 180 days after the date of the enactment of the Quantum Network Infrastructure Act of 2020, the Secretary shall submit to the Committee on Science, Space, and Technology of the House of Representatives and the Committee on Energy and Natural Resources of the Senate, a 4-year research plan that identifies and prioritizes basic research needs relating to quantum network infrastructure.
...
> - **(f)** *Funding* Funds authorized to be appropriated for the Department of Energy’s Office of Science, there shall be made available to the Secretary to carry out the activities under this section, $100,000,000 for each of fiscal years 2021 through 2025.
