...
- **(b)** *Content and function* The Secretary shall ensure that the website includes the following:
  - **(1)** With respect to each legislatively requested report, each of the following:
    ...
    - **(C)** The ability to retrieve a report, to the extent practicable, through searches based on each, and any combination, of the following:
      ...
      - **(iv)** The Act of Congress or con­fer­ence report that requests the report.
      - **(v)** Subject tags.
      - **(vi)** A unique alphanumeric identifier for the report that is consistent across report editions.
      - **(vii)** Any serial number, Su­per­in­ten­dent of Documents number, or other identification number for the report.
      - **(viii)** Key words.
      - **(ix)** Full text search.
  ...
  - **(4)** In tabular form, a list of all legislatively requested reports that can be searched, sorted, and downloaded by—
