...
- **(5)** by inserting after paragraph (4) the following:
  ...
  >       - **(II)** the individual is only able to work within a framework of specially arranged circumstances, such as a circumstance in which 1 or more other individuals are required to assist the individual in preparing for work or traveling to and from work;
  >     - **(iii)**
