...
- **(a)** *Definitions* In this section—
  ...
  - **(5)** the term Stamp Out Elder Abuse Semi­post­al Stamp means the semipostal stamp issued under subsection (b).
- **(b)** *Issuance* In order to afford a convenient way for members of the public to contribute to raising awareness of and combating elder abuse and to funding for elder justice activities, the Postal Service shall issue a semi­post­al stamp in accordance with subsection (c).
