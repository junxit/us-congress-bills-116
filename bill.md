...
- **(1)** Among cancers, lung cancer is the number 1 killer.
...
- **(7)** Free screening starts at age 40 for breast cancer but for lung cancer does not start until age 55, and then and only for individuals with a history of smoking 30 or more packs of cigarettes per year.
