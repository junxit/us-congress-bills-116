...
- **(a)** *Findings* Congress finds the following:
  - **(1)** According to the Tick-Borne Disease Working Group, an estimated 291,430 to 437,150 new cases of Lyme disease were reported in the United States in 2016.
  - **(2)** The Centers for Disease Control and Prevention (CDC) reports that Lyme disease is difficult to diagnose due to its diverse manifestations and a lack of reliable testing options.
  - **(3)** The National Institutes of Health (NIH) discovered that while Lyme disease symptoms can be managed with proper care, the disease currently has no cure.
  ...
  - **(5)** According to the Johns Hopkins Bloomberg School of Public Health, Lyme disease costs the United States healthcare system up to $1,300,000,000 dollars per year.
