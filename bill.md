...
## § 3. Extreme Risk Protection Grant Program
...
## § 4. National extreme risk protection order law

- **(a)** *Requirements* Legislation described in this section is legislation that establishes requirements that are substantially similar to the following:
