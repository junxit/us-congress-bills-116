...
## § 2. Automatic loan discharge for certain veteran borrowers
...
- **(1)** by striking paragraph (2) and inserting the following:
  ...
  >   - **(B)**
  >     - **(i)** notify the borrower of the intent of the Secretary to discharge the loans of the borrower under this subsection; and
  ...
  >   - **(D)** after the expiration of such period, discharge the loans of the borrower under this subsection, without any further action by the borrower (except that this subparagraph shall not apply to a borrower who opts out of such discharge under subparagraph (C)).
