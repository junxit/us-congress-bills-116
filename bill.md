...
This Act may be cited as the “Long-Term Unemployment Elimination Act of 2019”.
...
- **(1)** *Covered area* The term covered area means the local area in which a local board is carrying out a jobs program, or (in the circumstances described in section 4(d)) the local area in which a community-based organization is carrying out a jobs program, under this Act.
- **(2)** *Eligible worker* The term eligible worker means an individual who—
...
- **(3)** *Individual with a barrier to employment* The term individual with a barrier to employment has the meaning given in section 3(24) of the Workforce Innovation and Opportunity Act (29 U.S.C. 3102(24)), except that such term shall not include individuals who meet the terms of the definition in that section solely on the basis of their status as long-term unemployed individuals.
- **(4)** *On-the-job training* The term on-the-job training has the meaning given the term in section 3(44) of the Workforce Innovation and Opportunity Act (29 U.S.C. 3102(44)), except that subparagraph (B) of that section shall not apply.
...
- **(6)** *Payroll taxes* The term payroll taxes means taxes under section 3111, 3221, 3301, or 3321 of the Internal Revenue Code of 1986, and any similar State or local tax imposed on employers.
- **(7)** *Pre-apprenticeship* The term pre-apprenticeship, used with respect to a program, means a program that is designed to prepare individuals to enter and succeed in a registered apprenticeship program and is carried out by an entity that has a documented partnership with at least one sponsor of a registered apprenticeship program.
- **(8)** *Program position*
  - **(A)** *In general* The term program position, used with respect to a jobs program—
    - **(i)** means a position—
      ...
      - **(II)** that is provided along with, as necessary, supportive services and training services to enable an individual to succeed in the job and obtain and retain long-term employment; and
    - **(ii)** includes—
...
- **(12)** *Transitional job* The term transitional job means a job described in section 134(d)(5) of the Workforce Innovation and Opportunity Act (29 U.S.C. 3174(d)(5)), without regard to the limitation described in that section on funding for such jobs.
- **(13)** *WIOA terms* The terms adult education and literacy activities, career pathway, community-based organization, customized training, industry or sector partnership, in-demand industry sector or occupation, integrated education and training, local area, local board, one-stop operator, poverty line, State area, State board, supportive services, and training services have the meanings given the terms in section 3 of the Workforce Innovation and Opportunity Act (29 U.S.C. 3102).
- **(14)** *Worker-owned enterprise*
...
- **(a)** *In general*
  ...
  - **(4)** *Payments* The Secretary shall make such a payment in an amount that equals the eligible costs incurred by the local board—
    ...
    - **(B)** to provide supportive services and training services to eligible workers under this section; and
...
- **(b)** *Local board application* To be eligible to enter into an agreement under subsection (a), a local board shall submit an application to the Secretary at such time, in such manner, and containing a 4-year plan that includes such information as the Secretary may require, including—
  ...
  - **(2)** a plan for one-stop operators to identify the issues preventing each eligible worker served by the jobs program from securing employment, and to reduce the impact of those issues with supportive services and training services;
  - **(3)** a description of how the local board will engage labor organizations, community-based organizations, community colleges, economic development agencies, and area career and technical education schools as partners to provide training services to eligible workers, including any—
    ...
    - **(B)** pre-apprenticeship programs; and
    - **(C)** career pathways;
  ...
  - **(7)** a description of how the local board will align the activities carried out under the grant with the activities carried out under—
    - **(A)** the plans submitted by the corresponding State board and local board under subtitle A of title I of the Workforce Innovation and Opportunity Act (29 U.S.C. 3111 et seq.);
    ...
    - **(H)** the continuum of care projects (relating to ending homelessness) carried out under applications submitted, by communities serving an area that is substantially similar to the covered area, under subtitle C of title IV of the McKinney-Vento Homeless Assistance Act (42 U.S.C. 11381 et seq.); and
...
- **(d)** *Sanctions for failure To meet performance accountability measures or submit an application*
  ...
  - **(2)** *Repeated failure to meet performance accountability measures* If a local board fails to meet the performance accountability measures for at least 2 consecutive years, the Secretary may enter into an agreement with a community-based organization to carry out a jobs program serving the corresponding local area in place of the local board.
  - **(3)** *Failure to submit application* If a local board fails to submit an application under subsection (b) for a year, the Secretary may enter into an agreement with a community-based organization to carry out a jobs program serving the corresponding local area in place of the local board.
...
- **(e)** *Participating employer*
  - **(1)** *In general* A participating employer shall be selected by a local board. An entity who seeks to be a participating employer shall enter into an agreement with the local board to act as a participating employer under this subsection.
  - **(2)** *Selection criteria*
    ...
    - **(C)** *Labor organizations*
      - **(i)** *In general* The local board shall consider input from labor organizations to select participating employers.
      - **(ii)** *Collective bargaining agreements* For a site of employment at which workers are covered by a collective bargaining agreement, the local board shall not place a program participant in a program position at the site without the consent of all labor organizations representing workers at such site.
    ...
    - **(E)** *Community impact and input*
      - **(i)** *Community impact preference* The local board shall consider whether the employer is offering program positions in which the work to be performed is designed to have a positive impact on the communities in the local area served through the jobs program, and shall develop criteria for that positive impact based on input from members of such communities.
  ...
  - **(3)** *Participating employer duties* The participating employer shall—
    - **(A)** provide wages for each eligible worker in a program position at a rate that—
      - **(i)** is not less than the greatest of the 3 rates described in subsection (h)(1)(B); and
      - **(ii)** is the same as the customary rate paid by the employer for the same or similar work performed by other employees who—
        - **(I)** are not eligible workers in program positions;
        - **(II)** are similarly situated in similar occupations by the same employer; and
        - **(III)** have similar training, experience, and skills;
    - **(B)** provide benefits for each eligible worker in a program position at the same level as is provided to other employees who are not eligible workers in program positions;
    ...
    - **(E)** fulfill legal and administrative duties including payroll processing, tax withholding and documentation, and meeting liability requirements such as workers’ compensation requirements.
...
- **(f)** *Nondisplacement*
  - **(1)** *Nondisplacement of existing employees* The participating employer shall not place an eligible worker hired for a jobs program in a position under this Act if—
    ...
    - **(D)** such individual will perform the same work or substantially the same work as that performed by any individual, employed by the employer at the site of employment, who—
      ...
      - **(ii)** has not been offered to be restored to the position the employee had immediately prior to being laid off or partially displaced.
  ...
  - **(4)** *Limitation on program positions for participating employer*
    ...
    - **(D)** *Permission*
      - **(i)** *In general* A local board may grant permission for a participating employer to have a higher percentage or number of employees in program positions than is allowed under subparagraph (A) or (C)—
        ...
        - **(II)** under the circumstance described in clause (ii)(III), with the consent of all labor organizations representing workers at the site involved.
...
- **(g)** *Grievance procedure*
  - **(1)** *In general* The local board shall establish and maintain a procedure for the filing and adjudication of grievances from participants, labor organizations, and other interested individuals concerning participating employers, including grievances relating to proposed placements of eligible workers with such employers.
  ...
  - **(4)** *Arbitration*
    ...
    - **(D)** *Cost*
      ...
      - **(ii)** *Exception* If a participant, labor organization, or other interested individual described in paragraph (1) prevails under a binding arbitration proceeding, the other entity that is a party to such grievance shall pay the total cost of such proceeding and the attorneys’ fees of such participant, labor organization, or individual, as the case may be.
...
- **(h)** *Eligible costs*
  ...
  - **(3)** *Supportive services and training services*
    - **(A)** *Aggregate limit* The eligible costs of providing, or facilitating the provision of, supportive services and training services to eligible workers shall, in total, not exceed 20 percent of the total eligible costs of providing the wages described in paragraph (1)(B) to those eligible workers.
    - **(B)** *Flexibility for individuals* The limit in subparagraph (A) shall apply to the eligible costs for the total amount of supportive services and training services provided by a jobs program to all eligible workers, and shall not be construed to constitute a separate limit on the eligible costs for the supportive services and training services so provided to each eligible worker.
    - **(C)** *Modification* The requirements of this paragraph may be modified under section 5(e).
  - **(4)** *Administration*
    - **(A)** *Local boards* The eligible costs incurred by a local board of administering a jobs program under this section shall not exceed 10 percent of the total eligible costs of providing the wages described in paragraph (1)(B) to all eligible workers served by the jobs program.
    - **(B)** *Secretary* Of the maximum amount that the Secretary may make available under subparagraph (A) with respect to a jobs program, the Secretary may reserve not more than 10 percent to administer the jobs program under this section.
...
- **(j)** *Requirements for the Secretary of Labor* The Secretary shall—
  ...
  - **(4)** evaluate the performance of jobs programs carried out under this section;
  - **(5)** establish a clearinghouse to identify and publicize best practices used by local boards carrying out such jobs programs under this Act;
...
- **(k)** *Role of State boards* In order to assist local boards in carrying out programs under this Act, a State board may—
  ...
  - **(2)** facilitate coordination of programs carried out under this Act with the activities carried out under—
    - **(A)** the plan submitted by the corresponding State board under subtitle A of title I of the Workforce Innovation and Opportunity Act (29 U.S.C. 3111 et seq.);
    - **(B)** the employment and training program established by the corresponding State under the supplemental nutrition assistance program established under the Food and Nutrition Act of 2008 (7 U.S.C. 2011 et seq.);
    - **(C)** the corresponding State program for temporary assistance for needy families established under part A of title IV of the Social Security Act (42 U.S.C. 601 et seq.); and
    - **(D)** the national service plan submitted by the corresponding State Commission on National and Community Service under section 178 of the National and Community Service Act of 1990 (42 U.S.C. 12638);
  - **(3)** assist local boards in the process of submitting applications under this Act; and
  - **(4)** provide technical assistance to local boards and employers participating in programs under this Act.
- **(l)** *Payment*
...
- **(m)** *Mandatory funding* For the purpose of carrying out this section, there is authorized to be appropriated and there is appropriated, out of any money in the Treasury not otherwise appropriated, such sums as may be necessary for fiscal year 2020 and each subsequent fiscal year.
...
- **(a)** *Definitions* In this section:
  ...
  - **(2)** *Prime working-age employment-to-population ratio* The term prime working-age employment-to-population ratio, used with respect to an area, means the ratio of the number of individuals age 25 through 54 in the area who are employed, to the number of individuals age 25 through 54 in the area.
...
- **(c)** *Application* To be eligible to receive a grant under this section, a local board shall submit an application to the Secretary at such time, in such manner, and containing such information as the Secretary may require, including—
  - **(1)** a credible plan for the jobs program involved to achieve performance accountability measures described in section 4(c) through modified standards described in subsection (e), and sustain that achievement in the long term without permanent support from a grant awarded under this section;
...
- **(e)** *Modification of certain standards* In awarding a grant under this section to a local board, the Secretary is authorized to modify 1 or more of the following standards for the program carried out by the local board, if the Secretary determines that making such a modification can be reasonably expected to help the program achieve the performance accountability measures referred to in subsection (c)(1):
  - **(1)** The periods of time specified in subparagraphs (C) and (D) of section 3(2).
  ...
  - **(4)** The limitation on eligible costs for supportive services and training services, as specified in section 4(h)(3).
...
- **(f)** *Evaluations* The Secretary shall—
  - **(1)** evaluate the performance of jobs programs that receive funding under this section; and
...
- **(g)** *Authorization of appropriations* There are authorized to be appropriated to carry out this section such sums as may be necessary for fiscal year 2020 and each subsequent fiscal year.
