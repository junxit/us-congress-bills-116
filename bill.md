...
- **(a)** *In general* Section 604 of the Fair Credit Reporting Act (15 U.S.C. 1681b) is amended—
  ...
  - **(2)** in subsection (b)—
    - **(A)** in paragraph (1)—
      ...
      - **(ii)** in subparagraph (A), by redesignating clauses (i) and (ii) as subclauses (I) and (II), respectively (and conforming the margins accordingly);
      - **(iii)** by redesignating subparagraphs (A) and (B) as clauses (i) and (ii), respectively (and conforming the margins accordingly);
      ...
      - **(vi)** by adding at the end the following new subparagraph:
        > - **(B)** except as provided in paragraph (5), may not furnish a consumer report with respect to any consumer in which any information contained in the report bears on the consumer’s creditworthiness, credit standing, or credit capacity.
