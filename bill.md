...
## § 2. Additional preference to certain States that require certain public schools to have allergies and asthma management programs
...
- **(1)** in paragraph (1)(F)—
  ...
  - **(B)** by striking “epinephrine.—In determining” and inserting
    > epinephrine or school comprehensive allergies and asthma management program.—
    > - **(i)** *In general* In determining

  - **(C)** by striking “in the State—” and inserting
    > in the State satisfy the criteria described in clause (ii) or clause (iii).
